...
<head>
  ...
  <title>Gestion Intitut Académique</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>INSTITUT<span>ACADEMIQUE</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="Public/img/ecole.jpg" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href=Utilisateur?page=liste>General</a></li>
              <li><a href="buttons.html">A propos</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
